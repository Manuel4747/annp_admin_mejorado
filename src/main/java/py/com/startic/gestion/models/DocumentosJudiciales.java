...
@NamedQueries({
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findByCanalEntradaDocumentoJudicial", query = "SELECT d FROM DocumentosJudiciales d WHERE (d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial OR d.departamento = :departamento) ORDER BY d.fechaPresentacion DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findByCausa", query = "SELECT d FROM DocumentosJudiciales d WHERE d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.causa = :causa ORDER BY d.fechaPresentacion DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findByDescripcionMesaEntradaOrderedDptoTipoDoc", query = "SELECT d FROM DocumentosJudiciales d WHERE d.descripcionMesaEntrada like :descripcion AND d.tipoDocumentoJudicial = :tipoDocumentoJudicial AND (d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial OR d.departamento = :departamento) ORDER BY d.fechaHoraAlta DESC, d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findByNroMesaEntradaOrderedDptoTipoDoc", query = "SELECT d FROM DocumentosJudiciales d WHERE d.entradaDocumento.nroMesaEntrada like :nroMesaEntrada AND d.tipoDocumentoJudicial = :tipoDocumentoJudicial AND (d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial OR d.departamento = :departamento) ORDER BY d.fechaHoraAlta DESC, d.fechaHoraUltimoEstado DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findbyTipoExpedienteEstadoProcesoPersona", query = "SELECT d FROM DocumentosJudiciales d, PersonasPorDocumentosJudiciales p WHERE d.tipoExpediente.id = :tipoExpediente AND (d.estadoProceso.codigo = :estadoProceso1 OR d.estadoProceso.codigo = :estadoProceso2) AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND p.estado.codigo = :estadoPersona AND p.persona = :persona ORDER BY d.fechaHoraAlta DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrdered", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaPresentacion >= :fechaDesde AND d.fechaPresentacion <= :fechaHasta AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial ORDER BY d.fechaPresentacion DESC, d.fechaHoraUltimoEstado DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedAsignado2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaPresentacion >= :fechaDesde AND d.fechaPresentacion <= :fechaHasta AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial AND d.departamento = :departamento ORDER BY d.fechaHoraUltimoEstado DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedAsignadoAll2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaPresentacion >= :fechaDesde AND d.fechaPresentacion <= :fechaHasta AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial ORDER BY d.fechaHoraUltimoEstado DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedDescripcionMesaEntradaAsignado2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.descripcionMesaEntrada like :descripcionMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial AND d.departamento = :departamento and d.estado.tipo <> :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedDescripcionMesaEntradaAsignado3", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.descripcionMesaEntrada like :descripcionMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial AND d.departamento = :departamento and d.estado.tipo = :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedDescripcionMesaEntradaAsignadoAll2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.descripcionMesaEntrada like :descripcionMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial and d.estado.tipo <> :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedDescripcionMesaEntradaAsignadoAll3", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.descripcionMesaEntrada like :descripcionMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial and d.estado.tipo = :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedNroMesaEntradaAsignado2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.entradaDocumento.nroMesaEntrada like :nroMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial AND d.departamento = :departamento and d.estado.tipo <> :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedNroMesaEntradaAsignado3", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.entradaDocumento.nroMesaEntrada like :nroMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial AND d.departamento = :departamento and d.estado.tipo = :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    , @NamedQuery(name = "DocumentosJudiciales.findOrderedNroMesaEntradaAsignadoAll2", query = "SELECT d FROM DocumentosJudiciales d WHERE d.fechaHoraAlta > :fechaInicio AND d.entradaDocumento.nroMesaEntrada like :nroMesaEntrada AND d.canalEntradaDocumentoJudicial = :canalEntradaDocumentoJudicial AND d.tipoDocumentoJudicial IN :tiposDocumentoJudicial and d.estado.tipo <> :tipo ORDER BY d.fechaHoraUltimoEstado DESC")
    ...
    , @NamedQuery(name = "DocumentosJudiciales.findByCaratula", query = "SELECT d FROM DocumentosJudiciales d WHERE d.caratula = :caratula")
...
public class DocumentosJudiciales implements Serializable {
    ...
    public boolean verifObsAntecedente(){
        if(ultimaObservacionAntecedente == null &&  ultimaObservacionAntecedenteAux != null){
            return true;
