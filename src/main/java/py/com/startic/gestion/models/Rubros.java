...
@NamedQueries({
    ...
    , @NamedQuery(name = "Rubros.findOrdered", query = "SELECT r FROM Rubros r ORDER BY r.descripcion")
    ...
    , @NamedQuery(name = "Rubros.findByFechaHoraAlta", query = "SELECT r FROM Rubros r WHERE r.fechaHoraAlta = :fechaHoraAlta")
    , @NamedQuery(name = "Rubros.findByFechaHoraUltimoEstado", query = "SELECT r FROM Rubros r WHERE r.fechaHoraUltimoEstado = :fechaHoraUltimoEstado")})
public class Rubros implements Serializable {
    ...
    public Rubros(Integer id, String descripcion, Date fechaHoraAlta, Date fechaHoraUltimoEstado) {
        this.id = id;
