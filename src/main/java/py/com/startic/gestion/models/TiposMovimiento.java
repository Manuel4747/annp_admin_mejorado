...
public class TiposMovimiento implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.REFRESH, mappedBy = "tiposMovimiento")
    ...
    public TiposMovimiento(String codigo) {
        this.codigo = codigo;
    }

    public TiposMovimiento(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public String toString() {
        return "py.com.startic.gestion.TiposMovimiento[ codigo=" + codigo + " ]";
    }
