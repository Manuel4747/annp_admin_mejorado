...
@NamedQueries({
    ...
    , @NamedQuery(name = "Archivos.findByDocumentoJudicial", query = "SELECT t FROM Archivos t WHERE t.documentoJudicial = :documentoJudicial ORDER BY t.fechaHoraAlta DESC")
    , @NamedQuery(name = "Archivos.findByDocumentoJudicialOrdered", query = "SELECT t FROM Archivos t WHERE t.documentoJudicial = :documentoJudicial ORDER BY t.fechaHoraAlta")
    ...
    ,@NamedQuery(name = "Archivos.findByDocumentoFormularioSolicitudOrdered", query = "SELECT t FROM Archivos t WHERE t.formulariosPermisos = :formulariosPermisos ORDER BY t.fechaHoraAlta")
    ,@NamedQuery(name = "Archivos.findByDocumentoFormularioFiltroPdf", query = "SELECT t FROM Archivos t WHERE t.formulariosPermisos = :formulariosPermisos AND t.ruta like '%.pdf%'")
    ,@NamedQuery(name = "Archivos.findByDocumentoFormularioFiltroImagen", query = "SELECT t FROM Archivos t WHERE t.formulariosPermisos = :formulariosPermisos AND t.ruta not like '%.pdf%'")
