 ...
 */
@Entity
@Table(name = "excepciones_documento_administrativo")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ExcepcionesDocumentoAdministrativo.findAll", query = "SELECT r FROM ExcepcionesDocumentoAdministrativo r")
    , @NamedQuery(name = "ExcepcionesDocumentoAdministrativo.findByDepartamentoOrigen", query = "SELECT r FROM ExcepcionesDocumentoAdministrativo r WHERE r.departamentoOrigen = :departamentoOrigen order by r.departamentoDestino.nombre")})
public class ExcepcionesDocumentoAdministrativo implements Serializable {
    ...
    public ExcepcionesDocumentoAdministrativo() {
    }

    public ExcepcionesDocumentoAdministrativo(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        ExcepcionesDocumentoAdministrativo other = (ExcepcionesDocumentoAdministrativo) object;
    ...
    public String toString() {
        return "py.com.startic.gestion.models.Rubros[ id=" + id + " ]";
    }
