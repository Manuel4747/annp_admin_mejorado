 ...
 */
@Stateless
public class ChartDocumentosSecretariaPorDiaFacade extends AbstractFacade<ChartDocumentosSecretariaPorDia> {
    ...
    public ChartDocumentosSecretariaPorDiaFacade() {
    ...
    public List<ChartDocumentosSecretariaPorDia> getDocumentosMensual(Date fechaDesde, Date fechaHasta, List<TiposDocumentosJudiciales> listaTiposDoc) {

        return null;
    }

    public List<ChartDocumentosSecretariaPorDia> getComprasVariosPie(Date fechaDesde, Date fechaHasta, List<TiposDocumentosJudiciales> listaTiposDoc) {
