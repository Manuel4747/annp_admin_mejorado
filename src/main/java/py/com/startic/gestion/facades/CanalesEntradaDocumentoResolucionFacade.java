 ...
 */
@Stateless
public class CanalesEntradaDocumentoResolucionFacade extends AbstractFacade<CanalesEntradaDocumentoResolucion> {
    ...
    public CanalesEntradaDocumentoResolucionFacade() {
