 ...
 */
@Stateless
public class UsuariosPorDocumentosAdministrativosAutoguardadosFacade extends AbstractFacade<UsuariosPorDocumentosAdministrativosAutoguardados> {
    ...
    public UsuariosPorDocumentosAdministrativosAutoguardadosFacade() {
