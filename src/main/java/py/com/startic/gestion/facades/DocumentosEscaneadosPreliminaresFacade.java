 ...
 */
@Stateless
public class DocumentosEscaneadosPreliminaresFacade extends AbstractFacade<DocumentosEscaneadosPreliminares> {
    ...
    public DocumentosEscaneadosPreliminaresFacade() {
