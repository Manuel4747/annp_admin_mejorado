 ...
 */
@Stateless
public class ObservacionesDocumentosJudicialesPreliminaresFacade extends AbstractFacade<ObservacionesDocumentosJudicialesPreliminares> {
    ...
    public ObservacionesDocumentosJudicialesPreliminaresFacade() {
