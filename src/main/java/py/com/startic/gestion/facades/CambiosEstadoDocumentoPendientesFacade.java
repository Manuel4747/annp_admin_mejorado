 ...
 */
@Stateless
public class CambiosEstadoDocumentoPendientesFacade extends AbstractFacade<CambiosEstadoDocumentoPendientes> {
    ...
    public CambiosEstadoDocumentoPendientesFacade() {
