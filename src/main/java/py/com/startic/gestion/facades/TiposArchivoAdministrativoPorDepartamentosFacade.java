 ...
 */
@Stateless
public class TiposArchivoAdministrativoPorDepartamentosFacade extends AbstractFacade<TiposArchivoAdministrativoPorDepartamentos> {
    ...
    public TiposArchivoAdministrativoPorDepartamentosFacade() {
