 ...
 */
@Stateless
public class ExcepcionesDocumentoAdministrativoFacade extends AbstractFacade<ExcepcionesDocumentoAdministrativo> {
    ...
    public ExcepcionesDocumentoAdministrativoFacade() {
