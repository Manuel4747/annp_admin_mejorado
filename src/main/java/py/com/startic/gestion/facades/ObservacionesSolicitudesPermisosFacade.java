 ...
 */
@Stateless
public class ObservacionesSolicitudesPermisosFacade extends AbstractFacade<ObservacionesSolicitudesPermisos> {
    ...
    public ObservacionesSolicitudesPermisosFacade() {
