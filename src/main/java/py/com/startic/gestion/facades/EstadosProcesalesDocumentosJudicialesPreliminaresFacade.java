 ...
 */
@Stateless
public class EstadosProcesalesDocumentosJudicialesPreliminaresFacade extends AbstractFacade<EstadosProcesalesDocumentosJudicialesPreliminares> {
    ...
    public EstadosProcesalesDocumentosJudicialesPreliminaresFacade() {
