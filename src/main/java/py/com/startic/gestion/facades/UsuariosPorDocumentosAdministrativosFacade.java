 ...
 */
@Stateless
public class UsuariosPorDocumentosAdministrativosFacade extends AbstractFacade<UsuariosPorDocumentosAdministrativos> {
    ...
    public UsuariosPorDocumentosAdministrativosFacade() {
