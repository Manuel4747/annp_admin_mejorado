 ...
 */
@Stateless
public class SubcategoriasDocumentosAdministrativosFacade extends AbstractFacade<SubcategoriasDocumentosAdministrativos> {
    ...
    public SubcategoriasDocumentosAdministrativosFacade() {
