 ...
 */
@Stateless
public class CambiosEstadoDocumentoAdministrativoFacade extends AbstractFacade<TransferenciasDocumentoAdministrativo> {
    ...
    public CambiosEstadoDocumentoAdministrativoFacade() {
