 ...
 */
@Stateless
public class ObservacionesDocumentosAdministrativosFacade extends AbstractFacade<ObservacionesDocumentosAdministrativos> {
    ...
    public ObservacionesDocumentosAdministrativosFacade() {
