 ...
 */
@Stateless
public class EntradasDocumentosAdministrativosFacade extends AbstractFacade<EntradasDocumentosAdministrativos> {
    ...
    public EntradasDocumentosAdministrativosFacade() {
