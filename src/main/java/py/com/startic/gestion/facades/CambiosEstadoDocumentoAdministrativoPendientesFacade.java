 ...
 */
@Stateless
public class CambiosEstadoDocumentoAdministrativoPendientesFacade extends AbstractFacade<CambiosEstadoDocumentoAdministrativoPendientes> {
    ...
    public CambiosEstadoDocumentoAdministrativoPendientesFacade() {
