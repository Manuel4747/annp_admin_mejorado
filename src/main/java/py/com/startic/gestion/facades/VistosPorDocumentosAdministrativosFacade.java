 ...
 */
@Stateless
public class VistosPorDocumentosAdministrativosFacade extends AbstractFacade<VistosPorDocumentosAdministrativos> {
    ...
    public VistosPorDocumentosAdministrativosFacade() {
