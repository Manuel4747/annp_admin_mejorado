 ...
 */
@Stateless
public class CanalesEntradaDocumentoAdministrativoFacade extends AbstractFacade<CanalesEntradaDocumentoAdministrativo> {
    ...
    public CanalesEntradaDocumentoAdministrativoFacade() {
