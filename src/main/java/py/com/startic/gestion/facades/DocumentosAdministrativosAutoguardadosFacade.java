 ...
 */
@Stateless
public class DocumentosAdministrativosAutoguardadosFacade extends AbstractFacade<DocumentosAdministrativosAutoguardados> {
    ...
    public DocumentosAdministrativosAutoguardadosFacade() {
