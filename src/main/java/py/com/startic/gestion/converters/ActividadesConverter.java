...
import py.com.startic.gestion.facades.ActividadesFacade;
...
@FacesConverter(value = "actividadesConverter")
public class ActividadesConverter implements Converter {

    private ActividadesFacade ejbFacade;
    
    public ActividadesConverter() {
        this.ejbFacade = CDI.current().select(ActividadesFacade.class).get();
    }
