...
import py.com.startic.gestion.facades.PerfilesFacade;
...
@FacesConverter(value = "perfilesConverter")
public class PerfilesConverter implements Converter {

    private PerfilesFacade ejbFacade;
    
    public PerfilesConverter() {
        this.ejbFacade = CDI.current().select(PerfilesFacade.class).get();
    }
