...
@Named(value = "fotosBienesController")
@ViewScoped
public class FotosBienesController extends AbstractController<FotosBienes> {
    ...
    public FotosBienesController() {
        // Inform the Abstract parent controller of the concrete FotosBienes Entity
        super(FotosBienes.class);
    }
