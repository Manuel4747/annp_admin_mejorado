...
@Named(value = "especificacionesSubcuentaTodosController")
@ViewScoped
public class EspecificacionesSubcuentaTodosController extends AbstractController<EspecificacionesSubcuenta> {
    ...
    public EspecificacionesSubcuentaTodosController() {
    ...
    public Collection<EspecificacionesSubcuenta> getItems() {
            return ejbFacade.getEntityManager().createNamedQuery("EspecificacionesSubcuenta.findByOrdered", EspecificacionesSubcuenta.class).getResultList();
    }
