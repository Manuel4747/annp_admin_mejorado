...
@Named(value = "rhSalariosController")
@ViewScoped
public class RhSalariosController extends AbstractController<RhSalarios> {
    ...
    public RhSalariosController() {
        // Inform the Abstract parent controller of the concrete RhSalarios Entity
        super(RhSalarios.class);
    }
    ...
    @Override
    public Collection<RhSalarios> getItems() {
        ejbFacade.getEntityManager().getEntityManagerFactory().getCache().evictAll();
        return ejbFacade.getEntityManager().createNamedQuery("RhSalarios.findByUsuario", RhSalarios.class).setParameter("usuario", usuarioOrigen).getResultList();
    }
}
