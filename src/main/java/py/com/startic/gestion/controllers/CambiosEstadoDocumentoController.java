...
@Named(value = "cambiosEstadoDocumentoController")
@ViewScoped
public class CambiosEstadoDocumentoController extends AbstractController<CambiosEstadoDocumento> {
    ...
    @Override
    public CambiosEstadoDocumento prepareCreate(ActionEvent event) {
        CambiosEstadoDocumento movBien = super.prepareCreate(event);
    ...
    @Override
    public Collection<CambiosEstadoDocumento> getItems() {
        ejbFacade.getEntityManager().getEntityManagerFactory().getCache().evictAll();
        return ejbFacade.getEntityManager().createNamedQuery("CambiosEstadoDocumento.findByDocumentoJudicial", CambiosEstadoDocumento.class).setParameter("documentoJudicial", documentoJudicialOrigen).getResultList();
    }
    ...
    public void saveNew(ActionEvent event) {
        if (getSelected() != null) {
            ...
            setItems(ejbFacade.getEntityManager().createNamedQuery("CambiosEstadoDocumento.findByBien", CambiosEstadoDocumento.class).setParameter("bien", documentoJudicialOrigen).getResultList());
    ...
    public void delete(ActionEvent event) {
        super.delete(event);
        setItems(ejbFacade.getEntityManager().createNamedQuery("CambiosEstadoDocumento.findByDocumentoJudicial", CambiosEstadoDocumento.class).setParameter("documentoJudicial", documentoJudicialOrigen).getResultList());
    }
}
