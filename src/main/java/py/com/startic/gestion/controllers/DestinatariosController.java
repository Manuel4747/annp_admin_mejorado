...
public class DestinatariosController extends AbstractController<Destinatarios> {
    ...
    public void prepareVerDocs(Destinatarios dest) {
        List<Archivos> lista = ejbFacade.getEntityManager()
                ...
                .setParameter("documentosResolucion", dest.getDocumentosResoluciones())
                .getResultList();
        tipo = "";
    ...
    public void prepareTransferir(Destinatarios dest) {
        if (dest != null) {
            if (dest.getTipoDocumento().getCodigo().equals("DE")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", dest.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", dest.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_REENVIARDEDIRECCIONEJECUTIVA).getResultList();
            }
            ...
            if (dest.getTipoDocumento().getCodigo().equals("AL")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", dest.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", dest.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDESDEASUNTOSLEGALES).getResultList();
            }
            if (dest.getTipoDocumento().getCodigo().equals("SG")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", dest.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", dest.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDESDELASDG).getResultList();
            }
            ...
            if (dest.getTipoDocumento().getCodigo().equals("GG")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", dest.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", dest.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_REENVIARGABINETE).getResultList();
            }
            ...
            if (dest.getTipoDocumento().getCodigo().equals("AG")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", dest.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", dest.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDESDEDIRAUDITORIA).getResultList();
            }
        ...
        if (getSelected() != null) {
            for (Usuarios usu : listaUsuariosTransf) {
                ...
                if (responsableDestino.getDepartamento().getId() == 71) {
                    det.setTipoDocumento(new TiposDocumentosJudiciales("GA"));
                    det.setTipoEnvio(new TiposEnvio("VO"));
                    det.setEstado(new EstadosDocumento("-6"));
                }
                if (responsableDestino.getDepartamento().getId() == 52) {
