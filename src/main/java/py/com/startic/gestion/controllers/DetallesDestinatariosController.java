    ...
    public void prepareTransferir(DetallesDestinatarios det) {
        if (det != null) {
            ...
            if (det.getTipoDocumento().getCodigo().equals("DP")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", det.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", det.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDESDEPRESUPUESTO).getResultList();
            }
            if (det.getTipoDocumento().getCodigo().equals("DT")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", det.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", det.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDESDETIC).getResultList();
            }
            ...
            if (det.getTipoDocumento().getCodigo().equals("DU")) {
                listaUsuariosOpciones = this.ejbFacade.getEntityManager().createNamedQuery("Usuarios.findTransferir", Usuarios.class).setParameter("tipoDocumento", det.getTipoDocumento().getCodigo()).setParameter("estadoDocumentoActual", det.getEstado().getCodigo()).setParameter("rolEncargado", Constantes.ROL_RECIBIRDRDESDEDUOC).getResultList();
            }
            ...
            if (listaUsuariosOpciones != null) {
                ...
                JsfUtil.addErrorMessage("No se encuentra configuración de flujo de documento.");
                return;
            }
