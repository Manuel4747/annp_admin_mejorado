...
import py.com.annp.persistencia.facades.FnArticulosFacade;
  ...
  //@Inject
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof FnArticulos) {
            FnArticulos o = (FnArticulos) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), FnArticulos.class.getName()});
            return null;
        }
    }
