...
import py.com.annp.persistencia.facades.FnDetallePlanFinancieroFacade;
...
public class FnDetallePlanFinancieroConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof FnDetallePlanFinanciero) {
            FnDetallePlanFinanciero o = (FnDetallePlanFinanciero) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), FnDetallePlanFinanciero.class.getName()});
            return null;
        }
    }
