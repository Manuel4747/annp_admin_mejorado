 ...
 */
@Entity
@Table(name = "fn_sub_distribucion")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "FnSubDistribucion.findAll", query = "SELECT f FROM FnSubDistribucion f")
    , @NamedQuery(name = "FnSubDistribucion.findById", query = "SELECT f FROM FnSubDistribucion f WHERE f.id = :id")
    , @NamedQuery(name = "FnSubDistribucion.findByDescripcion", query = "SELECT f FROM FnSubDistribucion f WHERE f.descripcion = :descripcion")})
public class FnSubDistribucion implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "subDistribucion")
    ...
    public FnSubDistribucion() {
    }

    public FnSubDistribucion(Integer id) {
        this.id = id;
    }

    public FnSubDistribucion(Integer id, String descripcion) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FnSubDistribucion)) {
            return false;
        }
        FnSubDistribucion other = (FnSubDistribucion) object;
    ...
    public String toString() {
        return "py.com.staric.gestion.models.FnSubDistribucion[ id=" + id + " ]";
    }
